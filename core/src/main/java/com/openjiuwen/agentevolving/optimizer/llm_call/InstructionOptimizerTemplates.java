 ...
 * <p>
 * Mirrors Python's {@code openjiuwen.agent_evolving.optimizer.llm_call.templates}.
 * 
 * @since 0.1.7
 */
public final class InstructionOptimizerTemplates {
    /**
     * InstructionOptimizerTemplates.
     * 
     * @since 0.1.7
     */
    private InstructionOptimizerTemplates() {
        // Utility class
     ...
     * @since 0.1.7
     */
    public static final String PROMPT_INSTRUCTION_OPTIMIZE_TEMPLATE = """
     ...
     * @since 0.1.7
     */
    public static final String PROMPT_INSTRUCTION_OPTIMIZE_BOTH_TEMPLATE = """
        You are a prompt optimization expert. Your task is to optimize the prompt
        based on the provided information. The specific information is as follows:
     ...
     * @since 0.1.7
     */
    public static final String CREATE_PROMPT_TEXTUAL_GRADIENT_TEMPLATE = """
     ...
     * @since 0.1.7
     */
    public static final String CREATE_BAD_CASE_TEMPLATE = """
        [question]: {{question}}
    ...
    public static final String PLACEHOLDER_RESTORE_TEMPLATE = """
        As a prompt optimization expert, your task is to complete the placeholders in the prompt based on the \
        given information.
        Original prompt:
        <original_prompt>
        {{original_prompt}}
        ...
        After comparison, the revised prompt is missing the following placeholders compared to the original \
        prompt:
        ...
        2. Placeholders should be added to the prompt in double curly brace format, e.g., \
        "{{placeholder_name}}".
        3. Except for necessary modifications to placeholders, do not modify the prompt content.
        4. Directly return the prompt with placeholders added, without adding thought process or any other \
        additional content.
        """;
}
